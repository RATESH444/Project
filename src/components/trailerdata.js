...
export const trailersData = [
  {
    ...
    duration: "2h 45m",
    year: "2018",
    description: "A scientist works with a former soldier to stop giant mutated animals from destroying cities.",
    thumbnail: LT1,
    videoUrl: "https://www.youtube.com/watch?v=coOKvrsmQiI",
    credits: {
      director: { name: "Brad Peyton", image: FMD1 },
      producer: { name: "Beau Flynn", image: FMP1 },
      music: { name: "Andrew Lockington", image: LTS }
    }
  },
  {
    id: 2,
    ...
    duration: "2h 28m",
    year: "2025",
    description: "An intense action drama that focuses on power, loyalty, and survival.",
    thumbnail: LT2,
    ...
    credits: {
      ...
      music: { name: "Anirudh Ravichander", image: LTS }
    }
  },
  {
    id: 3,
    ...
    credits: {
      ...
      music: { name: "Alan Silvestri", image: LTS }
    }
  },
  {
    id: 4,
    ...
    duration: "2h 22m",
    year: "2024",
    description: "A gripping investigation uncovering hidden truths behind major historical events.",
    thumbnail: LT4,
    ...
    credits: {
      ...
      music: { name: "Original Score", image: LTS }
    }
  },
  {
    id: 5,
    ...
    duration: "2h 34m",
    year: "2024",
    description: "A romantic journey that explores love, heartbreak, and emotional healing.",
    thumbnail: LT5,
    ...
    credits: {
      ...
      music: { name: "Faheem Abdullah", image: LTS }
    }
  },
  {
    id: 6,
    ...
    duration: "2h 55m",
    year: "2024",
    description: "A fearless fighter takes on a powerful enemy to protect his loved ones.",
    thumbnail: LT6,
    ...
    credits: {
      ...
      music: { name: "Josh Brar", image: LTS }
    }
  },
  {
    id: 7,
    ...
    duration: "2h 16m",
    year: "2024",
    description: "Elite pilots face high-risk missions while defending national security.",
    thumbnail: LT7,
    ...
    credits: {
      ...
      music: { name: "Vishal Dadlani", image: LTS }
    }
  },
  {
    id: 8,
    ...
    duration: "2h 49m",
    year: "2014",
    description: "A futuristic story where technology and destiny collide.",
    thumbnail: LT8,
    ...
    credits: {
      ...
      music: { name: "Shankar Mahadevan", image: LTS }
    }
  },
  {
    id: 9,
    ...
    duration: "2h 12m",
    year: "2025",
    description: "A courtroom drama mixed with humor that questions justice and morality.",
    thumbnail: LT9,
    ...
    credits: {
      ...
      music: { name: "Background Score", image: LTS }
    }
  },
  {
    id: 10,
    ...
    duration: "2h 2m",
    year: "2019",
    description: "A disturbed man’s descent into madness in a broken society.",
    thumbnail: LT10,
    ...
    credits: {
      ...
      music: { name: "Hildur Guðnadóttir", image: LTS }
    }
  }
];
